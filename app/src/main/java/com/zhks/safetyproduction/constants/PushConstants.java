...
//    public static final String APP_KEY = "应用申请的Appkey";
    public static final String APP_KEY = "6281af96d0c3555248a2373b";

    /**
     * 应用申请的UmengMessageSecret
     */
//    public static final String MESSAGE_SECRET = "应用申请的UmengMessageSecret";
    public static final String MESSAGE_SECRET = "c6f9b3982985bd57c267995b2cec0418";

    /**
     * 后台加密消息的密码
     */
    public static final String APP_MASTER_SECRET = "eqjf5ngg2hti9m8suiipo9vpfylrjgkh";
