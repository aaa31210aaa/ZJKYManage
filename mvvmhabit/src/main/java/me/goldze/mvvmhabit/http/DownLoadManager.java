...
public class DownLoadManager {
    ...
    //下载
    public void load(String downUrl, DownLoadStateBean downLoadStateBean, final ProgressCallBack callBack) {
        retrofit.create(ApiService.class)
                ...
                .subscribe(new DownLoadSubscriber<ResponseBody>(callBack,downLoadStateBean));
    }
